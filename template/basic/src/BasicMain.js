( function(window) {
	...
	function loadComplete() {
		...
		var createLeftCol = document.getElementById('createLeftCol');
		main.style.width = (stageWidth() - 220) + "px";
		adminLabelCopy.style.width = (stageWidth() - 420) + "px";
		createLeftCol.style.width = (stageWidth() - 420) + "px";
		//nicEditButtons[0].style.width = (stageWidth() - 400) + "px";
		//nicEdit[0].style.width = (stageWidth() - 400) + "px";
		for(var i = 0; i < headers.length; i++) {
			headers[i].style.width = (stageWidth() - 420) + "px";
		}
		tinyMCE.init({
			mode : "textareas",
			theme : "simple"
